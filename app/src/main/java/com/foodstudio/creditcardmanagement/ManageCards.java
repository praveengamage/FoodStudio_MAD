package com.foodstudio.creditcardmanagement;
...
import com.foodstudio.creditcardmanagement.Models.CardDetails;
    ...
    class MyAdapter extends ArrayAdapter<CardDetails> {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                holder.button1 = (ImageView) view.findViewById(R.id.edit);
                holder.button2 = (ImageView) view.findViewById(R.id.delete);
